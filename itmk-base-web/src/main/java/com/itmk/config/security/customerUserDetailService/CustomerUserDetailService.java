package com.itmk.config.security.customerUserDetailService;
 ...
 * @Description 自定义UserDetailService，目的spring security如何查询用户信息
 */
@Component("customerUserDetailService") //把该类交给spring进行管理
